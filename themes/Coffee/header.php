...
<html lang="en">
  ...
  <head>
    ...
    <link href="<?=$config->theme_virtual?>css/business-casual.min.css" rel="stylesheet">
    <link href="<?=$config->theme_virtual?>css/blanche-style.css" rel="stylesheet">
  ...
  <body>
    ...
    <!-- //we lost the image reference and it broke the layout, potentially keep?
      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-9 mx-auto">
            <div class="text-center rounded blanche-inner"> <!-- cta-inner -->
            <!-- header ends here -->
